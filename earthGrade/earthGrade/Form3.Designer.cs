namespace earthGrade
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3.Location = new Point(110, 210);
            label3.Name = "label3";
            ...
            createEmail.Location = new Point(114, 165);
            ...
            createPassword.Location = new Point(114, 316);
            ...
            button1.Location = new Point(153, 388);
            ...
            pictureBox1.Location = new Point(124, 488);
            ...
            createUsername.Location = new Point(114, 238);
            ...
            // page1
            // 
            page1.Controls.Add(createUsername);
            page1.Controls.Add(pictureBox1);
            page1.Controls.Add(button2);
            page1.Controls.Add(button1);
            page1.Controls.Add(label1);
            page1.Controls.Add(createPassword);
            page1.Controls.Add(label2);
            page1.Controls.Add(label4);
            page1.Controls.Add(createEmail);
            page1.Controls.Add(label3);
            page1.Location = new Point(4, 3);
            page1.Name = "page1";
            page1.Size = new Size(446, 738);
            page1.TabIndex = 11;
            // 
            // Form3
            // 
